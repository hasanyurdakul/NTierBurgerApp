    ...
    public partial class nig_1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderDetailSauce", x => new { x.OrderDetailsOrderDetailId, x.SaucesSauceId });
                    table.ForeignKey(
                        name: "FK_OrderDetailSauce_OrderDetails_OrderDetailsOrderDetailId",
            ...
            migrationBuilder.InsertData(
                table: "Customers",
                columns: new[] { "CustomerId", "Address", "Email", "FirstName", "LastName", "PhoneNumber", "isActive" },
                values: new object[,]
                {
                    { 1, "123 Main St, Anytown, USA", "john.doe@example.com", "John", "Doe", "(555) 123-4567", true },
                    { 2, "456 Elm St, Smalltown, USA", "emily.smith@example.com", "Emily", "Smith", "(555) 234-5678", true },
                    { 3, "789 Oak St, Cityville, USA", "michael.johnson@example.com", "Michael", "Johnson", "(555) 345-6789", true },
                    { 4, "101 Maple Ave, Villagetown, USA", "sarah.williams@example.com", "Sarah", "Williams", "(555) 456-7890", true },
                    { 5, "202 Cedar St, Townsville, USA", "christopher.brown@example.com", "Christopher", "Brown", "(555) 567-8901", true },
                    { 6, "303 Pine St, Hamletville, USA", "jessica.davis@example.com", "Jessica", "Davis", "(555) 678-9012", true },
                    { 7, "404 Birch St, Suburbia, USA", "matthew.miller@example.com", "Matthew", "Miller", "(555) 789-0123", true },
                    { 8, "505 Walnut St, Riverside, USA", "ashley.wilson@example.com", "Ashley", "Wilson", "(555) 890-1234", true },
                    { 9, "606 Oak St, Hillside, USA", "daniel.moore@example.com", "Daniel", "Moore", "(555) 901-2345", true },
                    { 10, "707 Maple St, Lakeside, USA", "amanda.taylor@example.com", "Amanda", "Taylor", "(555) 012-3456", true },
                    { 11, "808 Pine St, Mountainview, USA", "robert.martinez@example.com", "Robert", "Martinez", "(555) 123-4567", true },
                    { 12, "909 Cedar St, Beachtown, USA", "jennifer.hernandez@example.com", "Jennifer", "Hernandez", "(555) 234-5678", true },
                    { 13, "111 Birch St, Countryside, USA", "james.lopez@example.com", "James", "Lopez", "(555) 345-6789", true },
                    { 14, "222 Elm St, Riverside, USA", "mary.gonzalez@example.com", "Mary", "Gonzalez", "(555) 456-7890", true },
                    { 15, "333 Oak St, Suburbia, USA", "david.wilson@example.com", "David", "Wilson", "(555) 567-8901", true },
                    { 16, "444 Maple St, Cityville, USA", "maria.taylor@example.com", "Maria", "Taylor", "(555) 678-9012", true },
                    { 17, "555 Pine St, Hillside, USA", "charles.martinez@example.com", "Charles", "Martinez", "(555) 789-0123", true },
                    { 18, "666 Cedar St, Townsville, USA", "patricia.hernandez@example.com", "Patricia", "Hernandez", "(555) 890-1234", true },
                    { 19, "777 Birch St, Lakeside, USA", "richard.lopez@example.com", "Richard", "Lopez", "(555) 901-2345", true },
                    { 20, "888 Elm St, Beachside, USA", "linda.gonzalez@example.com", "Linda", "Gonzalez", "(555) 012-3456", true },
                    { 21, "999 Pine St, Citytown, USA", "thomas.martinez@example.com", "Thomas", "Martinez", "(555) 123-4567", true },
                    { 22, "101 Oak St, Countryside, USA", "karen.hernandez@example.com", "Karen", "Hernandez", "(555) 234-5678", true },
                    { 23, "202 Cedar St, Riverside, USA", "steven.lopez@example.com", "Steven", "Lopez", "(555) 345-6789", true },
                    { 24, "303 Elm St, Suburbia, USA", "barbara.gonzalez@example.com", "Barbara", "Gonzalez", "(555) 456-7890", true },
                    { 25, "404 Maple St, Hillside, USA", "joseph.taylor@example.com", "Joseph", "Taylor", "(555) 567-8901", true },
                    { 26, "505 Pine St, Lakeside, USA", "donna.martinez@example.com", "Donna", "Martinez", "(555) 678-9012", true },
                    { 27, "606 Oak St, Beachside, USA", "ronald.hernandez@example.com", "Ronald", "Hernandez", "(555) 789-0123", true },
                    { 28, "707 Cedar St, Smalltown, USA", "laura.lopez@example.com", "Laura", "Lopez", "(555) 890-1234", true },
                    { 29, "808 Elm St, Mountainview, USA", "kenneth.gonzalez@example.com", "Kenneth", "Gonzalez", "(555) 901-2345", true },
                    { 30, "909 Oak St, Beachtown, USA", "margaret.wilson@example.com", "Margaret", "Wilson", "(555) 012-3456", true },
                    { 31, "101 Maple Ave, Cityville, USA", "karen.martinez@example.com", "Karen", "Martinez", "(555) 123-4567", true },
                    { 32, "202 Cedar St, Townsville, USA", "anthony.hernandez@example.com", "Anthony", "Hernandez", "(555) 234-5678", true },
                    { 33, "303 Elm St, Hillside, USA", "sharon.lopez@example.com", "Sharon", "Lopez", "(555) 345-6789", true },
                    { 34, "404 Pine St, Countryside, USA", "gary.gonzalez@example.com", "Gary", "Gonzalez", "(555) 456-7890", true },
                    { 35, "505 Cedar St, Riverside, USA", "deborah.taylor@example.com", "Deborah", "Taylor", "(555) 567-8901", true },
                    { 36, "606 Oak St, Suburbia, USA", "edward.martinez@example.com", "Edward", "Martinez", "(555) 678-9012", true },
                    { 37, "707 Elm St, Lakeside, USA", "kimberly.hernandez@example.com", "Kimberly", "Hernandez", "(555) 789-0123", true },
                    { 38, "808 Cedar St, Beachside, USA", "steven.lopez@example.com", "Steven", "Lopez", "(555) 890-1234", true },
                    { 39, "909 Elm St, Mountainview, USA", "susan.gonzalez@example.com", "Susan", "Gonzalez", "(555) 901-2345", true },
                    { 40, "101 Pine St, Beachtown, USA", "brian.wilson@example.com", "Brian", "Wilson", "(555) 012-3456", true },
                    { 41, "202 Maple Ave, Cityville, USA", "elizabeth.martinez@example.com", "Elizabeth", "Martinez", "(555) 123-4567", true },
                    { 42, "303 Oak St, Townsville, USA", "charles.hernandez@example.com", "Charles", "Hernandez", "(555) 234-5678", true },
                    { 43, "404 Elm St, Hillside, USA", "donna.lopez@example.com", "Donna", "Lopez", "(555) 345-6789", true },
                    { 44, "505 Cedar St, Countryside, USA", "david.gonzalez@example.com", "David", "Gonzalez", "(555) 456-7890", true },
                    { 45, "606 Maple St, Riverside, USA", "jennifer.taylor@example.com", "Jennifer", "Taylor", "(555) 567-8901", true },
                    { 46, "707 Elm St, Suburbia, USA", "michael.martinez@example.com", "Michael", "Martinez", "(555) 678-9012", true },
                    { 47, "808 Pine St, Lakeside, USA", "barbara.hernandez@example.com", "Barbara", "Hernandez", "(555) 789-0123", true },
                    { 48, "909 Oak St, Beachside, USA", "john.lopez@example.com", "John", "Lopez", "(555) 890-1234", true },
                    { 49, "101 Cedar St, Mountainview, USA", "jessica.gonzalez@example.com", "Jessica", "Gonzalez", "(555) 901-2345", true },
                    { 50, "202 Pine St, Smalltown, USA", "jason.taylor@example.com", "Jason", "Taylor", "(555) 012-3456", true }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderDetailSauce_SaucesSauceId",
